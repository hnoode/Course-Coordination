...
<form action="" method="post">
  <div class="panel panel-primary"  style="width:50%;margin:20px auto">
      ...
      <table class="table table-conseded table-hover">
        ...
        <tr>
          <th>Email *</th>
          <td><input type="text" maxlength="9" class="form-control" name="email" id="email" placeholder="Enter Email" style="width: 200px; float: left"  value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" >
          <span class="col-md-6" style="padding-top: 7px;">@pnu.edu.sa</span>
          </td>
        </tr>
        <tr>
          <th>Username *</th>
          <td><input type="text" class="form-control" name="username"  autocomplete="username*"  id="username"  value="<?php if(isset($_POST['username'])) echo $_POST['username']; ?>" maxlength="10" placeholder="Enter User Name">
          </td>
        </tr>
        <tr>
          <th>Password *</th>
