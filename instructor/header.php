  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li  <?php if(!isset($_GET['p']) or $_GET['p'] == 'main') echo ' class="active" '; ?>><a href="index.php" >Welcome <i class="glyphicon glyphicon-education"></i> <?php echo $_SESSION['username'] ?> As Instructor.</a></li>
        <li <?php if(isset($_GET['p']) and ($_GET['p'] == 'courses' or $_GET['p'] == 'add_course' or $_GET['p'] == 'course_details' or $_GET['p'] == 'filter_courses')) echo ' class="active" '; ?>><a href="?p=courses">Courses</a></li>
         <li  <?php if(isset($_GET['p']) and ($_GET['p'] == 'posts' or $_GET['p'] == 'add_post'  or $_GET['p'] == 'post_details')) echo ' class="active" '; ?>><a href="?p=posts">Posts</a></li>
